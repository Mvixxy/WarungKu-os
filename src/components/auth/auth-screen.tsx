    ...
    <div className="relative flex h-dvh items-center justify-center overflow-hidden bg-background px-4">
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center">
          <div className="mx-auto flex size-10 items-center justify-center rounded-2xl bg-primary text-primary-foreground">
            <Store className="size-5" />
          </div>
          <h1 className="mt-2 font-heading text-lg font-semibold tracking-tight">
            WarungKu
          </h1>
